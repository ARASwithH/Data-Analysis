...
total_customers = train_set.groupby('Store_id')['NumberOfCustomers'].sum().reset_index()
store_set = store_set.merge(total_customers, on='Store_id', how='left')
store_set.rename(columns={'NumberOfCustomers': 'total customers'}, inplace=True)
